    ...
    >
      ...
      <div className="absolute inset-0 flex items-center justify-center gap-8 md:gap-16 pointer-events-none">
        <button
          ...
          className="pointer-events-auto text-white hover:text-primary transition hover:-rotate-12 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary p-2 rounded-full"
        ...
        <button
          ...
          className="pointer-events-auto text-white hover:scale-110 hover:text-primary transition bg-black/40 backdrop-blur-sm p-4 rounded-full border border-white/10 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary"
          ...
          <div className="flex items-center gap-4">
            <label className="flex items-center gap-2 text-xs text-white/80">
              ...
              <select
                ...
                className="rounded-md border border-white/20 bg-black/50 px-2 py-1 text-xs text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary"
